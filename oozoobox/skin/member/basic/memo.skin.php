...
<div class="btn-group btn-group-justified">
	<a href="./memo.php?kind=recv" class="btn btn-sm btn-black<?php echo ($kind == "recv") ? ' active' : '';?>">收到的信息</a>
	<a href="./memo.php?kind=send" class="btn btn-sm btn-black<?php echo ($kind == "send") ? ' active' : '';?>">发送的信息</a>
	<a href="./memo_form.php" class="btn btn-sm btn-black<?php echo ($kind == "") ? ' active' : '';?>">些信息</a>
</div>
...
<tr class="active">
	...
	<th class="text-center" scope="col"><?php echo  ($kind == "recv") ? "发件人" : "收件人";  ?></th>

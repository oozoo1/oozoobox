...
<div class="myresponse-skin">
	<div class="panel panel-default" style="padding-bottom:0px;">
		<div class="res-info bg-black">
			<i class="fa fa-microphone fa-lg"></i> 我发布的内容 有误时 请点击重置！
		</div>
		...
		<?php if($i == 0) { ?>
			<div class="panel-body">
				<p class="text-center text-muted">目前没有发布内容.</p>
			</div>
		<?php } ?>
	</div>
</div>
...
<p class="text-center">
	<a class="btn btn-color btn-sm" href="<?php echo $all_href;?>">确认</a>
	<a class="btn btn-black btn-sm" href="<?php echo $recount_href;?>">重置</a>
	<a class="btn btn-black btn-sm" href="#" onclick="window.close();">关闭</a>
</p>

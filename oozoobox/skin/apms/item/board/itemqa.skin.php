...
<div class="qa-btn">
	...
	<div class="pull-right">
		<div class="btn-group">
			<button type="button" class="btn btn-color btn-sm" onclick="apms_form('itemqa_form', '<?php echo $itemqa_form; ?>');">
				<i class="fa fa-pencil"></i> 문의쓰기<span class="sound_only"> 새 창</span>
			</button>
			<a class="btn btn-black btn-sm" href="<?php echo $itemqa_list; ?>"><i class="fa fa-plus"></i> 더보기</a>
			<?php if($admin_href) { ?>

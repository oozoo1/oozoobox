...
<div class="item-icon">
	<div class="pull-right">
		<div class="form-group">
			<a href="#" class="btn btn-black btn-sm" onclick="apms_recommend('<?php echo $it['it_id']; ?>', '<?php echo $ca_id; ?>'); return false;"><i class="fa fa-send"></i> 추천</a>
			<a href="#" class="btn btn-<?php echo ($is_orderform) ? 'black' : 'color';?> btn-sm" onclick="apms_wishlist('<?php echo $it['it_id']; ?>'); return false;"><i class="fa fa-heart"></i> 위시</a>
			<?php if($is_orderform) { // 주문가능시에만 출력 ?>
				<a href="#" class="btn btn-color btn-sm" data-toggle="modal" data-target="#cartModal" onclick="return false;"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs">주문/담기</span></a>
			<?php } ?>
		</div>
	</div>
	<div class="pull-left">

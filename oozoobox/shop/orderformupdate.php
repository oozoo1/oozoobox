...
// Push - 최고관리자에게 보냄 ---------------------------------------
	...
	$psubj = '[주문]'.$od_name.'님의 주문('.$od_id.')이 접수되었습니다.';
	$pcont = '번호 '.$od_id.' // 금액 '.number_format($tot_ct_price + $od_send_cost + $od_send_cost2).'원 // 상태 : '.$od_status;
	if($od_memo) $pcont .= ' // 메모 : '.$od_memo;
	$purl = G5_URL;

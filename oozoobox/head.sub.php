...
// SEO
if($is_seometa) include_once(G5_LIB_PATH.'/apms.meta.lib.php');
?>
...
if (defined('_SHOP_')) {
    if(!G5_IS_MOBILE) {
		echo '<script src="'.G5_JS_URL.'/jquery.shop.menu.js"></script>'.PHP_EOL;
    }
} else {
	echo '<script src="'.G5_JS_URL.'/jquery.menu.js"></script>'.PHP_EOL;
}
*/
?>
...
<body<?php echo isset($g5['body_script']) ? $g5['body_script'] : ''; ?> class="<?php echo (_RESPONSIVE_) ? '' : 'no-';?>responsive <?php echo $body_mode;?>">
<?php

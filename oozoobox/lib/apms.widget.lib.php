...
function apms_carousel_options($value) {
	...
	$options .= '<option value="2"'.get_selected('2', $value).'>버티컬</option>'.PHP_EOL;
	$options .= '<option value="3"'.get_selected('3', $value).'>효과없음</option>'.PHP_EOL;
...
function apms_member_options($value) {
	...
	$options = '<option value="point"'.get_selected('point', $value).'>포인트</option>'.PHP_EOL;

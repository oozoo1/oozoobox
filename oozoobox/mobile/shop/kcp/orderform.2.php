...
<div id="display_pay_button" class="btn_confirm">
    ...
    <span id="show_pay_btn" style="display:none;"><input type="button" onClick="forderform_check();" value="确认下单" class="btn_submit"></span>
    <a href="<?php echo G5_SHOP_URL; ?>" class="btn_cancel">取消</a>
</div>

...
if ($w == 'u') {
	...
	sql_query(" ALTER TABLE `{$g5['write_prefix']}{$board['bo_table']}` ADD `as_level` int(11) NOT NULL DEFAULT '1' AFTER `as_extra` ", false);
	...
	sql_query(" ALTER TABLE `{$g5['write_prefix']}{$board['bo_table']}` ADD `as_re_mb` varchar(20) NOT NULL DEFAULT '' AFTER `as_choice_cnt` ", false);
	...
	sql_query(" ALTER TABLE `{$g5['write_prefix']}{$board['bo_table']}` ADD `as_icon` varchar(255) NOT NULL AFTER `as_tag` ", false);
	sql_query(" ALTER TABLE `{$g5['write_prefix']}{$board['bo_table']}` ADD `as_update` datetime NOT NULL default '0000-00-00 00:00:00' AFTER `as_icon` ", false);
}
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
				...
				<input type="text" name="as_max" value="<?php echo $board['as_max'] ?>" id="as_max" class="frm_input" size="4"> 레벨까지 회원만 이용가능합니다.
            </td>
            <td class="td_grpset">
        ...
        <tr>
            <th scope="row"><label for="as_comment_rows">PC <br> 댓글 페이지당 목록수</label></th>
            <td>
                <?php echo help('0 입력시 페이징을 하지 않고 그누보드 기본형태 댓글을 사용합니다.') ?>
				<input type="text" name="as_comment_rows" value="<?php echo $board['as_comment_rows'] ?>" id="as_comment_rows" class="frm_input" size="4">
            </td>
            <td class="td_grpset">
        ...
        <tr>
            <th scope="row"><label for="as_comment_mobile_rows">모바일 <br> 댓글 페이지당 목록수</label></th>
            <td>
                <?php echo help('0 입력시 페이징을 하지 않고 그누보드 기본형태 댓글을 사용합니다.') ?>
				<input type="text" name="as_comment_mobile_rows" value="<?php echo $board['as_comment_mobile_rows'] ?>" id="as_comment_mobile_rows" class="frm_input" size="4">
            </td>
            <td class="td_grpset">
                <input type="checkbox" name="chk_grp_as_comment_mobile_rows" value="1" id="chk_grp_as_comment_mobile_rows">
                <label for="chk_grp_as_comment_mobile_rows">그룹적용</label>
                <input type="checkbox" name="chk_all_as_comment_mobile_rows" value="1" id="chk_all_as_comment_mobile_rows">
                <label for="chk_all_as_comment_mobile_rows">전체적용</label>
            </td>
        </tr>
        <tr>
		...
		<tr>
            <th scope="row"><label for="as_lightbox">라이트박스</label></th>
            <td>
                <label><input type="checkbox" name="as_lightbox" value="1" id="as_lightbox" <?php echo $board['as_lightbox']?'checked':''; ?>>
				내용 이미지 크게보기를 라이트박스로 봅니다.</label>
            </td>
            <td class="td_grpset">

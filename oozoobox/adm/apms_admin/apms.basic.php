...
<div class="local_ov01 local_ov">
	<b>주의!</b> 파트너 유형이 하나라도 설정되어 있어야 파트너 등록신청을 받을 수 있습니다.
</div>
...
<section>
	<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            ...
            <td>
                판매금액의 <input type="text" name="apms_commission_1" value="<?php echo $apms['apms_commission_1'] ?>" id="apms_commission_1" class="required numeric frm_input" size="4"> %
			</td>
		</tr>
		<tr>
			<th scope="row">컨텐츠상품 수수료</th>
            <td>
                판매금액의 <input type="text" name="apms_commission_2" value="<?php echo $apms['apms_commission_2'] ?>" id="apms_commission_2" class="required numeric frm_input" size="4"> %
			</td>
		</tr>
		<tr>

...
sql_query(" ALTER TABLE `{$g5['board_new_table']}` ADD `as_re_mb` varchar(20) NOT NULL DEFAULT '' AFTER `as_lucky` ", false);
...
sql_query(" ALTER TABLE `{$g5['member_table']}` ADD `as_date` int(11) NOT NULL DEFAULT '0' AFTER `as_memo` ", false);

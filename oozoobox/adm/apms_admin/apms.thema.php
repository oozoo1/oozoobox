...
<div class="local_ov01 local_ov">
	<b>안내</b> 기본테마와 별도로 보드그룹/아이템 분류별 개별테마 설정은 메뉴설정에서 하실 수 있으며, 그누테마 사용시 아미나빌더의 자동메뉴 등 중 일부 기능은 작동하지 않습니다.
</div>
...
<div class="tbl_head01 tbl_wrap">
	...
	?>
	<td align="center">
		<select name="as_intro_skin" style="width:120px;">
	...
	<td align="center">
		<select name="as_mobile_intro_skin" style="width:120px;">
			<option value="">사용안함</option>
			<?php 
				for ($k=0; $k<count($introskin); $k++) {
	...
	<?php if(IS_YC) { ?>
		...
		<td align="center">
			<select name="as_shop_intro_skin" style="width:120px;">
				<option value="">사용안함</option>
				<?php 
					for ($k=0; $k<count($introskin); $k++) {
		...
		<td align="center">
			<select name="as_shop_mobile_intro_skin" style="width:120px;">
				<option value="">사용안함</option>
				<?php 
					for ($k=0; $k<count($introskin); $k++) {
...
<div class="local_desc01 local_desc">
	<p>
		...
		<label><input type="checkbox" name="as_gnu" value="1"<?php echo ($config['as_gnu']) ? ' checked' : ''; ?> id="as_gnu"> 환경설정 > 테마설정에 있는 그누테마를 사용합니다.</label>
	</p>
</div>
<?php echo $frm_submit; ?>

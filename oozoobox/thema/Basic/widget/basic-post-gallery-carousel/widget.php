...
$wset['item'] = ($wset['item'] > 0) ? $wset['item'] : 2;
...
<div id="<?php echo $slider_id;?>" class="carousel div-carousel<?php echo $effect;?> widget-basic-post-gallery-carousel" data-ride="carousel" data-interval="<?php echo $interval;?>">

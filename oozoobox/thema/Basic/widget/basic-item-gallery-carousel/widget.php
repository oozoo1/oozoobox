...
?>
<style>
	#<?php echo $slider_id;?> .item-wrap { margin-right:<?php echo $minus;?>px; margin-bottom:-30px; }
	#<?php echo $slider_id;?> .item-row { width:<?php echo apms_img_width($wset['item']);?>%; }
	#<?php echo $slider_id;?> .item-list { margin-right:<?php echo $gap;?>px; margin-bottom:30px; }
</style>
<div id="<?php echo $slider_id;?>" class="carousel div-carousel<?php echo $effect;?> widget-basic-item-gallery-carousel<?php echo (G5_IS_MOBILE) ? ' item-mobile' : '';?>" data-ride="carousel" data-interval="<?php echo $interval;?>">
